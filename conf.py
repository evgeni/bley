...
# in a prominent link
SITE_URL = "https://bley.mx/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://bley.mx"
BLOG_EMAIL = "evgeni@golov.de"
BLOG_DESCRIPTION = "intelligent greylisting"  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -rav --delete output/ root@shokki.die-welt.net:/srv/syscp/webs/sargentd/bley.mx/",
    ]
}
...
GITHUB_SOURCE_BRANCH = 'page-source'
